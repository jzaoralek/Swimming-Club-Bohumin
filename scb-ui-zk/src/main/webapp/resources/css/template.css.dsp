...
.navbarPopup1.z-popup:before,
.navbarPopup1.z-menupopup:before {
...
.navbarPopup1.z-popup:after,
.navbarPopup1.z-menupopup:after {
...
.navbarPopup2.z-popup:before,
.navbarPopup2.z-menupopup:before {
  border-bottom: 7px solid rgba(0, 0, 0, 0.2);
  border-left: 7px solid transparent;
  border-right: 7px solid transparent;
  content: "";
...
.navbarPopup2.z-popup:after,
.navbarPopup2.z-menupopup:after {
  border-bottom: 6px solid #FFFFFF;
  border-left: 6px solid transparent;
  border-right: 6px solid transparent;
  content: "";
...
.alert-success.z-window {
    background-color: #dff0d8 !important;
}

.alert-danger.z-window {
    background-color: #f2dede !important;
    border-color: #ebccd1;
}

.alert-danger.z-window .z-window-header {
    color: #a94442;
}
...
.alert-info.z-window .z-window-header {
   color: #31708f;
}
...
.z-tabbox .z-tabs-content li{
    margin-bottom: -1px;
    position: relative;
}

.z-tabbox .z-tab-selected {
    border-color: #4c8fbd #c5d0dc #c5d0dc;
    border-style: solid;
...
.z-window-modal.z-window-shadow, .z-window-highlighted.z-window-shadow {
    border-radius: 0px;
    box-shadow: none;
    box-shadow: 5px 2px 10px rgba(0, 0, 0, 0.7);
}
...
.z-window-modal .z-window-header, .z-messagebox-window .z-window-header {
	color: white;
	font-family: "Open Sans";
	font-size: 14px;
}

.z-window-modal .z-window-header .z-window-close, .z-messagebox-window .z-window-header .z-window-close{
	background: none;
    border: none;
    border-radius: 0px;
    color: white;
...
.combo-empty-content .z-listbox{
	border: solid 1px #428bca;
	box-shadow: 1px 1px 10px rgba(0, 0, 0, 0.5);
}

.combo-empty-content .z-listbox .z-listitem-selected{
	background-color: #6fb3e0;
}

.combo-empty-content .z-listbox .z-listitem-selected .z-listcell-content{
	color: white;
}
...
.z-listbox .z-listbox-header, .z-grid .z-grid-header {
...
.main-menu .z-menu, .main-menu-bar > ul > li.z-menuitem{
	border-width: 0 0 0 1px;
	border-color: #e5e5e5;
	border-style: solid;
	margin: 0px;
...
.main-menu .active.z-menu, .main-menu-bar > ul > li.active.z-menuitem{
	border-width: 0 1px 0 1px;
	border-color: #79b0ce;
	border-style: solid;
	position: relative;
...
.main-menu-bar a.z-menu-content, .main-menu-bar a.z-menuitem-content{
	line-height: 22px;
    padding: 10px 14px;
    margin: 0;
    background-color: #f8f8f8;
...
.main-menu-bar a.z-menu-content:HOVER, .main-menu-bar a.z-menuitem-content:HOVER{
	background: white;
	border: 0px;
	color: #2b7dbc;
	margin: 0;
...
.main-menu .z-menu-clickable .z-menu-separator {
	height: 0;
}

.main-menu-bar li.active a.z-menu-content, .main-menu-bar li.active a.z-menuitem-content{
	color: #2b7dbc;
	background-color: white;
}

.main-menu .z-menu-hover > .z-menu-content, .main-menu .z-menuitem-hover > .z-menuitem-content {
    background: none;
    border: 0px;
}

.main-menu .z-menubar a.z-menu-content > .z-menu-text, .main-menu-bar .z-menuitem-content > .z-menuitem-text{
	font-size: 13px;
}
...
.main-menu-bar span.z-menu-text {
	
}

.main-menu-bar i.z-menu-icon {
	display: none;
}
...
.main-menu .main-menu-bar > ul > li.active > a::after{
	content: "";
	height: 3px;
	background-color: white;
	display: block;
...
.main-menu .main-menu-bar > ul > li.active > a::before{
	content: "";
	height: 2px;
	background-color: #428bca;
	display: block;
...
.main-menu .quick-buttons .qb-container{
	display: inline-block;
	width: 45px;
	height: 45px;
	background-color: inherit;
...
.main-menu .quick-buttons .qb-container .z-button{
	width: 20px;
	height: 20px;
	display: inline-block;
	border: none;
...
/*
 * styly se aplikují, když:  'šířka prohlížeče' > 900px 
 */
...
.z-menuitem-content .z-menuitem-text{
	white-space: normal;
	padding-right: 30px;
}

.main-menu-bar .z-menuitem-content .z-menuitem-text{
	white-space: normal;
	padding-right: 0px;
}
