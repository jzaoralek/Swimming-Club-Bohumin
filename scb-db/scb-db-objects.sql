...
DROP TABLE IF EXISTS mail_message_send;
DROP TABLE IF EXISTS covid19_confirmation;
DROP TABLE IF EXISTS covid19_configł
...
CREATE TABLE payment(
	uuid varchar(36),
	amount INT,
	type ENUM('CASH','BANK_TRANS','DONATE','DISCOUNT','OTHER') NOT NULL,
